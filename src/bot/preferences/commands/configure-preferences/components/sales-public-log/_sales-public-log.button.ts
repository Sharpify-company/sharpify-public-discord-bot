...
@Injectable()
export class SalesPublicLogButtonComponent {
	constructor(
	...
	@Button("go_to_sales_public_log_settings")
	...
	async createButton() {
		const salesPublicLogButton = new ButtonBuilder()
			.setCustomId("go_to_sales_public_log_settings")
			.setLabel("Configurar log de vendas publico")
			.setStyle(ButtonStyle.Secondary);
		return { salesPublicLogButton };
	}
}
