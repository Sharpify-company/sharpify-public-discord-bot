...
Object.defineProperty(exports, "FeedbackPublicLogButtonComponent", {
    enumerable: true,
    get: function() {
        return FeedbackPublicLogButtonComponent;
    }
});
...
let FeedbackPublicLogButtonComponent = class FeedbackPublicLogButtonComponent {
    ...
    async createButton() {
        const feedbackPublicLogButton = new _discord.ButtonBuilder().setCustomId("go_to_feedback_public_log_settings").setLabel("Configurar log de feedback publico").setStyle(_discord.ButtonStyle.Secondary);
        return {
...
_ts_decorate([
    (0, _necord.Button)("go_to_feedback_public_log_settings"),
...
], FeedbackPublicLogButtonComponent.prototype, "log", null);
FeedbackPublicLogButtonComponent = _ts_decorate([
...
//# sourceMappingURL=_feedback-public-log.button.js.map