...
@Injectable()
export class SelectFailLogChannel {
	constructor(
	...
	@ChannelSelect("select_fail_log_channel")
	...
	async createSelectChannel() {
		...
		const selectMenu = new ChannelSelectMenuBuilder()
			.setCustomId(`select_fail_log_channel`)
			.setPlaceholder("Selecione qual canal o log de falhas vai ser mandado...")
			.setMaxValues(1)
			.setMinValues(1);
