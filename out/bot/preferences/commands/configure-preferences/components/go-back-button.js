...
Object.defineProperty(exports, "GoBackButtonComponent", {
    enumerable: true,
    get: function() {
...
let GoBackButtonComponent = class GoBackButtonComponent {
    async goBackButton([interaction]) {
    ...
    async createButton() {
        const goBackButtonButton = new _discord.ButtonBuilder().setCustomId("go_back_to_main_preference_settings").setLabel("⬅️ Voltar").setStyle(_discord.ButtonStyle.Secondary);
        return {
            goBackButtonButton
        };
    }
...
_ts_decorate([
    (0, _necord.Button)("go_back_to_main_preference_settings"),
...
], GoBackButtonComponent.prototype, "goBackButton", null);
GoBackButtonComponent = _ts_decorate([
...
//# sourceMappingURL=go-back-button.js.map