...
@Injectable()
export class FeedbackPublicLogButtonComponent {
	constructor(
	...
	@Button("go_to_feedback_public_log_settings")
	...
	async createButton() {
		const feedbackPublicLogButton = new ButtonBuilder()
			.setCustomId("go_to_feedback_public_log_settings")
			.setLabel("Configurar log de feedback publico")
			.setStyle(ButtonStyle.Secondary);
		return { feedbackPublicLogButton };
	}
}
