...
Object.defineProperty(exports, "FailLogButtonComponent", {
    enumerable: true,
    get: function() {
        return FailLogButtonComponent;
    }
});
...
let FailLogButtonComponent = class FailLogButtonComponent {
    ...
    async createButton() {
        const failLogButton = new _discord.ButtonBuilder().setCustomId("go_to_fail_log_settings").setLabel("Configurar log de falhas").setStyle(_discord.ButtonStyle.Secondary);
        return {
            failLogButton
        };
    }
...
_ts_decorate([
    (0, _necord.Button)("go_to_fail_log_settings"),
...
], FailLogButtonComponent.prototype, "log", null);
FailLogButtonComponent = _ts_decorate([
...
], FailLogButtonComponent);

//# sourceMappingURL=_fail-log.button.js.map