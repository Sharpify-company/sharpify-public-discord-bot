...
Object.defineProperty(exports, "SalesPrivateLogButtonComponent", {
    enumerable: true,
    get: function() {
        return SalesPrivateLogButtonComponent;
    }
});
...
let SalesPrivateLogButtonComponent = class SalesPrivateLogButtonComponent {
    async disablePrivateLog([interaction]) {
    ...
    async createButton() {
        const salesPrivateLogButton = new _discord.ButtonBuilder().setCustomId("go_to_sales_private_log_settings").setLabel("Configurar log de vendas privado").setStyle(_discord.ButtonStyle.Secondary);
        return {
...
_ts_decorate([
    (0, _necord.Button)("go_to_sales_private_log_settings"),
...
], SalesPrivateLogButtonComponent.prototype, "disablePrivateLog", null);
SalesPrivateLogButtonComponent = _ts_decorate([
...
//# sourceMappingURL=_sales-private-log.button.js.map