...
let ConfigureRolesCommand = class ConfigureRolesCommand {
    async onConfigureRoles([interaction]) {
        return interaction.reply(await this.buildPreferenceConfigure.build({
            section: "MAIN"
        }));
    }
    constructor(buildPreferenceConfigure){
...
ConfigureRolesCommand = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _buildpreferenceconfigure.BuildPreferenceConfigure === "undefined" ? Object : _buildpreferenceconfigure.BuildPreferenceConfigure
    ])
], ConfigureRolesCommand);

//# sourceMappingURL=configure-preferences.command.js.map