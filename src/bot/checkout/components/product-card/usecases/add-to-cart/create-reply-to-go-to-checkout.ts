...
export async function CreateReplyToGoToCheckout({
	interaction,
	channel,
}: Parameters<typeof AddToCartUsecase.prototype.execute>[0] & { channel: TextChannel }) {
	const embed = new EmbedBuilder()
		.setDescription(`✅ **Carrinho de compra criado com sucesso em** ${channel} — ${interaction.user}`)
		.setColor(0x57f287);
